...
Revision ID: 5640d1ab5620
Revises: b5941b32aa07
Create Date: 2020-03-30 19:22:44.395291
...
revision = '5640d1ab5620'
down_revision = 'b5941b32aa07'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('tour_id', sa.Integer(), nullable=False),
    sa.Column('tour_date', sa.DateTime(), server_default=FetchedValue(), nullable=False),
    sa.ForeignKeyConstraint(['tour_id'], ['TOUR.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
