...
Revision ID: 26b9113dfe9b
Revises: c7739a5ea109
Create Date: 2020-03-31 16:12:46.180235
...
revision = '26b9113dfe9b'
down_revision = 'c7739a5ea109'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('uuid', postgresql.UUID(as_uuid=True), server_default='uuid_generate_v1()', nullable=False),
